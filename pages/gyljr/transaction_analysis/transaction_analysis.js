// pages/gyljr/transaction_analysis/transaction_analysis.js
...
Page({
  ...
  onLoad: function (options) {
    var _this = this
    console.log(options)
    var debtee = options['debtee']
    var debtor = options['debtor']
    var fund_provider = options['fund_provider']
    wx.showLoading({
      title: '结果分析中',
    })
    wx.request({
      ...
      success(res) {
        ...
        options2.series[0].data = mockData.nodes
        options2.series[0].links = mockData.links
        // options2.series[0].categories = mockData.categories
